...
export my_ansible="ANSIBLE_PIPELINING=True ANSIBLE_NO_TARGET_SYSLOG=True ANSIBLE_CALLBACK_RESULT_FORMAT=yaml ansible-playbook --extra-vars local_only=/data/mine/git -i inventory"
