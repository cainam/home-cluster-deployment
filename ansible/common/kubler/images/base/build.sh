...
finish_rootfs_build()
{
  ...
  env-update
    ...
    #export DISTRIBUTION_DIR="${GOPATH}/src/github.com/ns/img1"
    #mkdir -p "${DISTRIBUTION_DIR}"

    #git clone https://github.com/ns/img1.git "${DISTRIBUTION_DIR}"
    #cd "${DISTRIBUTION_DIR}"
    #git checkout tags/v${_img1_version}
    #echo "building img1 ${_img1_version}.."
    ...
    #log_as_installed "manual install" "img1-${_img1_version}" "https://img1.org/"
